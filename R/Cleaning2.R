...
traits <-read.csv("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/LeafTraits_SeedClim.csv", header=TRUE, sep = ";", stringsAsFactors = FALSE)
...
LA <- read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/Leaf_area_total.csv", stringsAsFactors = FALSE)
...
CN <- read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/CNratio.csv", dec=".", sep=";")

#Making a dictionary for the CN name abreviations

dict_CN <- read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/Dict_CN.csv", header = TRUE, sep=";", stringsAsFactors = FALSE)
...
traitdata_trans <- traitdata %>% 
  ...
  mutate(Value_trans = ifelse(Trait %in% c("Height", "Wet_Mass", "Dry_Mass", "Leaf_Area"), log(Value), Value),
         Trait = recode(Trait, "Leaf_area" = "Leaf_Area_cm2",
                        "SLA" = "SLA_cm2_g",
                        "Dry_Mass" = "Dry_Mass_g",
                        "Wet_Mass" = "Wet_Mass_g",
                        "Lth_ave" = "Leaf_Thickness_Ave_mm",
                        "Height" = "Plant_Height_mm"),
         Trait_trans = recode(Trait, "Plant_Height_cm" = "Plant_Height_cm_log", "Wet_Mass_g" = "Wet_Mass_g_log", "Dry_Mass_g" = "Dry_Mass_g_log", "Leaf_Area" = "Leaf_Area_log"))
...
systematics_species<- read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/systematics_species.csv", sep=";", stringsAsFactors = FALSE)

species_info<- read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/species_info.csv", sep=";", stringsAsFactors = FALSE)
...
community <-read.csv2("//hjemme.uib.no/rgy042/PhD/seedclimComm/seedclimComm/Traits/data/funcab_composition_2016.csv", header=TRUE, sep=";", stringsAsFactors = FALSE)
